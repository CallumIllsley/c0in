...
import { outgoingsHistoricQuery, generateOutgoingsReport } from '../../actions'

function OutgoingsHistoricForm() {
        ...
        <div className={Styles.outgoingsFormContainer}> 
            <div className={Styles.outgoingsFormWrapper}>
                ...
                <Form className={Styles.form} onSubmit={ () => {
                        dispatch(outgoingsHistoricQuery(dates))
                        dispatch(generateOutgoingsReport(true))
...
export default OutgoingsHistoricForm