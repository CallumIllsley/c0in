...
function OutgoingsHistoricChart() {
    const [currentHeight, setCurrentHeight] = React.useState()
    const ref = React.useRef(null) 
    const dates = useSelector(state => state.outgoingsHistoricQuery)

    let data = useSelector(state => state.outgoingsHistoricContent)
...
export default OutgoingsHistoricChart